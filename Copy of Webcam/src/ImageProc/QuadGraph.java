...
public class QuadGraph extends PApplet {
    ...
    public ArrayList<ArrayList<PVector>> build(List<PVector> lines, int width, int height) {
    	...
    	ArrayList<PVector> candidateCorners = new ArrayList<PVector>();
        ...
        ArrayList<ArrayList<PVector>> aa = new ArrayList<ArrayList<PVector>>();
        
        aa.add(candidateCorners);
    //    aa.add(candidateLines);
    ...
    public static boolean isConvex(PVector c1,PVector c2,PVector c3,PVector c4){
    	...
    	List<PVector> ll = new ArrayList<PVector>();
    	ll.add(c1); ll.add(c2) ; ll.add(c3) ; ll.add(c4);
    	List<PVector> caca = TwoDThreeD.sortCorners(ll);
