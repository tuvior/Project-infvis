...
void draw() {
  ...
  float[][] transform1 = scaleMatrix(x, y, z);
  float[][] transform2 = rotateXMatrix(tx);
  float[][] transform3 = rotateYMatrix(ty);
  
  translate((width-100)/2, (height-150)/2, 0); 
...
My3DBox transformBox(My3DBox box, float[][] transformMatrix) {
   return(new My3DBox( new My3DPoint[] {euclidian3DPoint(matrixProduct(transformMatrix, homogeneous3DPoint(box.p[0]))),
